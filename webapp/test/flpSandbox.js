		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Plugin for Azure App Insights",
									"targetURL": "#microsoftcomflpmonitor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"microsoftcomflpmonitor-display": {
								"semanticObject": "microsoftcomflpmonitor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=microsoft.com.flpmonitor",
									"url": sap.ui.require.toUrl("microsoft/com/flpmonitor")
								}
							}
						}
					}
